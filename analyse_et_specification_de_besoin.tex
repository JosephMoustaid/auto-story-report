...
\begin{itemize}
    \item Le code doit être commenté et documenté (JSDoc pour JavaScript)
    ...
    \item Les endpoints API doivent être documentés (Postman collections)
\end{itemize}
...
\begin{itemize}
    \item \textbf{Backend :} Node.js 18+, Express.js 4+
    \item \textbf{Base de données :} MongoDB 6+, Mongoose 7+
    \item \textbf{Frontend :} React 18+, TypeScript 5+
    \item \textbf{3D Graphics :} Three.js, WebGL
    \item \textbf{LLM :} Google Gemini 2.5 Flash
    \item \textbf{Video Generation :} Puppeteer (headless browser)
