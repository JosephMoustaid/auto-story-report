...
Ce rapport présente le \textbf{Projet de Fin d'Année (PFA)} intitulé \textit{AutoStory}, réalisé à l'\textbf{École Marocaine des Sciences de l'Ingénieur (EMSI)} dans le cadre de la filière \textbf{MIAGE}. L'objectif principal de ce projet est le développement d'un \textbf{système automatisé de génération de vidéos publicitaires} pour le secteur automobile, exploitant les capacités des \textbf{Large Language Models (LLMs)} et des technologies de synthèse vocale.
\vspace{1em}
